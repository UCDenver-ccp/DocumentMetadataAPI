...
//         //             configFile(fileId: 'database.cnf', targetLocation: 'database.cnf'),
//         //             configFile(fileId: 'docmetadataapi_flask.conf', targetLocation: 'docmetadataapi_flask.conf'),
...
//         //                 /bin/bash prepare.sh
//         //                 cd translator-ops/ops/tmkp/docmetadataapi/
//         //                 /bin/bash deploy.sh
//         //                 '''
//         //             }
//         //         }
